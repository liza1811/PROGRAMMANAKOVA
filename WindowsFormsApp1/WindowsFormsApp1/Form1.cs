...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        private void OpenDBFile()
        {
            ...
            SQLiteCommand command = new SQLiteCommand("select distinct Genre from music  ", SQLiteConn);
            ...
            while (read.Read())
            {
                comboBox2.Items.Add((string)read["Year"]);
            }
            while (rea.Read())
            {
            ...
            private void button1_Click(object sender, EventArgs e)
        {
        ...
        
            {
                ...
                {
                    sq = $"SELECT Name FROM music where  Genre = '{g}' AND Year = '{year}'";
                    SQLiteCommand command = new SQLiteCommand(sq, SQLiteConn);
                    SQLiteDataReader sQLiteDataReader = command.ExecuteReader();
                    SQLiteDataReader reader = sQLiteDataReader;
        ...
        private void button3_Click_1(object sender, EventArgs e)
        {
            if (listBox1.SelectedItems.Count != 0)
            {
                ...
                string name = $"update music set[play] = '+' where Name = '{listBox1.Text}'";
